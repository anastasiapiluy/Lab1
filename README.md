...
> Программа получает на вход 2 числа a и b, где a и b — параметры. Нужно решить неравенство
$\frac{a}{x*(b-x)}$ ≥0 для x. 

### 2. Входные и выходные данные
   В условии не указан тип входных данных, поэтому будем считать их вещественными числами
...
Рассмотрим неравенство $\frac{a}{x*(b-x)}$ ≥0. Область определения: x∈R \ {0,b}. 
Также b ≠ x.
